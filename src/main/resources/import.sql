...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$OhhI88kwmUioZt5M9BWS.uWktQw0Qa.ASzQkpcg1tOBvoorj6v2Ie',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$yaeuAaZLs1/jFSvGOsoW/uwIiPbvvufpMlSpYL1HZjWALXe/i5qFa',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
...
INSERT INTO productos (nombre, precio, create_at) VALUES('Mac Pro', 299990, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Galaxy s10', 239990, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES('Huawei Mate Pro ', 9999999, NOW());
